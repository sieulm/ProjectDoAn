...
<div class="container">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ Route('admin.post.update', ['id' => $post->id]) }}" method="post" id="mainForm" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select name="post_category_id" id="post_category_id" class="form-control" required>
                                ...
                                <option value="{{ $category->id }}" <?php if($post->post_category_id == $category->id) { ?>selected<?php } ?>>{{ $category->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="event_date" id="event_date" value="{{ $post->event_date }}" class="form-control">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" cols="30" rows="10" class="form-control" required>{{ $post->description }}</textarea>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
