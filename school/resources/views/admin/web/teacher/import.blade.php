...
<div class="container">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ Route('admin.teacher.storeImport') }}" method="post" enctype="multipart/form-data" id="mainForm">
                @csrf
                <div class="row">
            ...
            <div class="row">
                <div class="col-12">
                    <small class="text-secondary">
                        *File import mẫu có thể tải ở đây. Cột "Mã khoa" (bắt buộc) có thể đối chiếu ở dưới hai bảng dưới đây.
                    </small>
                </div>
                <div class="col-12 mb-3">
                    <a href="{{ route('admin.teacher.download.import_file') }}">
