...
@section('content')
<div class="container">
    <a href="{{ Route('artsyv.experience.all') }}">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ Route('artsyv.experience.storeUpdate', ['id' => $experience->id]) }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <br/>
                            <input type="text" name="label" id="label" class="form-control" value="{{ $experience->label }}" required>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <br/>
                            <input type="text" name="labelVi" id="labelVi" value="{{ $experience->labelVi }}" class="form-control">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="content" id="contentt" cols="30" rows="10" class="form-control" required>{{ $experience->content }}</textarea>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="contentVi" id="contenttVi" cols="30" rows="10" class="form-control">{{ $experience->contentVi }}</textarea>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" name="end" id="end" class="form-control" value="{{ $experience->end }}" required>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <!-- Rounded switch -->
                        <label class="switch">
                            <input type="checkbox" name="active" id="active" <?php if($experience->active == 1) {?>checked<?php } ?> >
