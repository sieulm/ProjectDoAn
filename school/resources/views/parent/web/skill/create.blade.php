...
<div class="container">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ Route('artsyv.skill.store') }}" method="post">
                @csrf
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" max="100" name="level" id="level" required class="form-control" placeholder="Skill evaluation (for example: 50%)">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
